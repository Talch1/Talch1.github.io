...
var FavoritesComponent = /** @class */ (function () {
    ...
    FavoritesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.weather.currentMessage.subscribe(function (favoritCity) { return _this.favoritCity = favoritCity; });
        this.getLocation();
    };
    FavoritesComponent.prototype.getLocation = function () {
        var _this = this;
        for (var index = 0; index < this.favoritCity.length; index++) {
            this.weather.getLocation(this.lang, this.key, this.favoritCity[index]).subscribe(function (response) {
                _this.locationArr = response;
                _this.location1 = _this.locationArr[0];
                _this.locKey = _this.location1.Key;
                _this.cityNunbrs.push(_this.locKey);
                _this.getCurrentlyWeather();
            }, function (err) {
                alert("Error " + err.massage);
            });
        }
    };
    FavoritesComponent.prototype.getCurrentlyWeather = function () {
        var _this = this;
        var _loop_1 = function (index) {
            this_1.weather.getCurrentWeather(this_1.lang, this_1.key, this_1.cityNunbrs[index]).subscribe(function (response) {
                _this.currentWeatherArr = response;
                _this.currentWeather = _this.currentWeatherArr[0];
                _this.favorites.city = _this.favoritCity[index];
                _this.favorites.todayWheather = String(_this.currentWeather.Temperature.Metric.Value);
                _this.favorites.weatherIcon = _this.currentWeather.WeatherIcon;
                _this.favoriteArr.push(_this.favorites);
            }, function (err) {
                alert("Error " + err.massage);
            });
        };
        var this_1 = this;
        for (var index = 0; index < this.cityNunbrs.length; index++) {
            _loop_1(index);
        }
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(rout, weather) {
        this.rout = rout;
        this.weather = weather;
    }
    ...
    HeaderComponent.prototype.GoToFavorite = function () {
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.receveData = function () {
    ...
    HomeComponent.prototype.receiveFromChild = function (evnt) {
        this.fromChild = evnt;
        this.receveData();
    };
...
var FiveDaysInstance = /** @class */ (function () {
    function FiveDaysInstance() {
    }
    return FiveDaysInstance;
}());
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.sendToParent = function () {
        this.outToParent.emit([this.city, this.todayTemperature, this.weatherIcon, this.daily]);
    };
    SearchComponent.prototype.getLocation = function () {
        var _this = this;
        this.weather.getLocation(this.lang, this.key, this.city).subscribe(function (response) {
            _this.locationArr = response;
            _this.location1 = _this.locationArr[0];
            _this.locKey = _this.location1.Key;
            _this.getCurrentlyWeather();
    ...
    SearchComponent.prototype.getCurrentlyWeather = function () {
        var _this = this;
        this.weather.getCurrentWeather(this.lang, this.key, this.locKey).subscribe(function (response) {
            _this.currentWeatherArr = response;
            _this.getFiveDayWeather();
            _this.currentWeather = _this.currentWeatherArr[0];
            _this.todayTemperature = _this.currentWeather.Temperature.Metric.Value;
            _this.weatherIcon = _this.currentWeather.WeatherIcon;
        }, function (err) {
            alert("Error " + err.massage);
        });
    };
    SearchComponent.prototype.getFiveDayWeather = function () {
        var _this = this;
        this.weather.getFiveDayWeather(this.lang, this.key, this.location1).subscribe(function (response) {
            _this.fiveDays = response;
            _this.daily = _this.fiveDays.DailyForecasts;
            _this.sendToParent();
        }, function (err) {
            alert("Error " + err.massage);
        });
...
var WeatherServiceService = /** @class */ (function () {
    ...
    WeatherServiceService.prototype.changeMessage = function (message) {
        this.messageSource.next(message);
    };
    WeatherServiceService.prototype.getLocation = function (lang, key, city) {
        return this.http.get(this.baseUrl1 + "/cities/autocomplete?q=" + city + "&language=" + lang + "&apikey=" + key);
    };
    WeatherServiceService.prototype.getCurrentWeather = function (lang, apiKey, locKey) {
        return this.http.get(this.baseUrl2 + "/" + locKey + "?apikey=" + apiKey + "&language=" + lang + "&details=false");
    };
    WeatherServiceService.prototype.getFiveDayWeather = function (lang, key, loc) {
        return this.http.get(this.baseUrl3 + "/" + loc.Key + "?apikey=" + key + "&language=" + lang + "&details=false&metric=true");
    };
    WeatherServiceService.ctorParameters = function () { return [
